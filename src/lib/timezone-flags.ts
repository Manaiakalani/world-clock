...
// Generated from /usr/share/zoneinfo/zone.tab + legacy aliases
...
const TIMEZONE_TO_COUNTRY: Record<string, string> = {
  ...
  "Africa/Porto-Novo": "BJ", "Africa/Sao_Tome": "ST", "Africa/Tripoli": "LY",
  ...
  "America/Bahia_Banderas": "MX", "America/Bahia": "BR", "America/Barbados": "BB",
  ...
  "America/Catamarca": "AR", "America/Cayenne": "GF", "America/Cayman": "KY",
  ...
  "America/Coyhaique": "CL", "America/Creston": "CA", "America/Cuiaba": "BR",
  "America/Curacao": "CW", "America/Danmarkshavn": "GL", "America/Dawson_Creek": "CA",
  "America/Dawson": "CA", "America/Denver": "US", "America/Detroit": "US",
  ...
  "America/Los_Angeles": "US", "America/Louisville": "US",
  ...
  "America/Nassau": "BS", "America/New_York": "US", "America/Nome": "US",
  ...
  "America/Paramaribo": "SR", "America/Phoenix": "US", "America/Port_of_Spain": "TT",
  "America/Port-au-Prince": "HT", "America/Porto_Velho": "BR",
  ...
  "Asia/Calcutta": "IN", "Asia/Chita": "RU", "Asia/Colombo": "LK",
  ...
  "Asia/Karachi": "PK", "Asia/Kathmandu": "NP", "Asia/Katmandu": "NP",
  ...
  "Asia/Tehran": "IR", "Asia/Thimphu": "BT", "Asia/Tokyo": "JP", "Asia/Tomsk": "RU",
...
/** Get the flag emoji for a given IANA timezone */
export function getFlagForTimezone(timezone: string): string {
  const code = TIMEZONE_TO_COUNTRY[timezone];
  if (!code) return "🌐";
  return countryCodeToFlag(code);
}

/** Get the ISO country code for a timezone */
export function getCountryCode(timezone: string): string | null {
